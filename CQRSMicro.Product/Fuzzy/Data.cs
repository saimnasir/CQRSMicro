...
namespace CQRSMicro.Product.Fuzzy
{
    public static class Data
    {
        public static List<Campaign> Campaigns => new List<Campaign>
        {
            ...
            new Campaign { BrandId = 5, Title = "Movie Night Extravaganza", Description = "Enjoy movie nights with our blockbuster deals", Content = "Grab your popcorn and get ready for a cinematic experience", CampaignType = "Entertainment" },
            ...
            new Campaign { BrandId = 8, Title = "Fitness Tracker Launch", Description = "Stay fit with our latest fitness tracker launch", Content = "Track your fitness goals with advanced fitness technology", CampaignType = "Health" },
